...
test_responses.append(
    {
        "original": HtmlResponse(
            ...
            request=Request(
                ...
                meta={"crawlera_fetch_original_request": {"url": "https://fake.host.com"}},
            ),
...
test_responses.append(
    {
        "original": HtmlResponse(
            ...
            request=Request(
                SETTINGS["CRAWLERA_FETCH_URL"],
                meta={"crawlera_fetch_original_request": {"url": "https://httpbin.org/get"}},
            ),
...
test_responses.append(
    {
        "original": HtmlResponse(
            ...
            request=Request(
                SETTINGS["CRAWLERA_FETCH_URL"],
                meta={"crawlera_fetch_original_request": {"url": "https://example.org"}},
            ),
